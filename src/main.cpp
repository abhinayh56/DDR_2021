...
void loop()
{
	...
	Serial.print(th0);
	Serial.print('\t');
	Serial.print(state.th * 180.0 / PI);
	Serial.println('\t');
...
void calibrate_gyro()
{
	for (int i = 0; i < 15000; i++)
	{
		...
		if (i % 10 == 0)
		{
			Serial.print(angle_state.get_bias_gy_x(), 4);
			Serial.print('\t');
			Serial.print(angle_state.get_bias_gy_y(), 4);
			Serial.print('\t');
...
void calibrate_acc_out()
{
	...
	for (uint32_t i = 0; i < N; i++)
	{
		...
		if (i % 10 == 0)
		{
			Serial.print(angle_state.get_bias_ac_x(), 6);
			Serial.print('\t');
			Serial.print(angle_state.get_bias_ac_y(), 6);
			Serial.print('\t');
...
void print_angles()
{
	Serial.print(state.phi * 180 / PI);
	Serial.print('\t');
	Serial.print(state.th * 180 / PI);
	Serial.print('\t');
	Serial.print(state.psi * 180 / PI);
	Serial.print('\t');
}

void print_angular_velocity()
{
	Serial.print(state.wx * 180 / PI);
	Serial.print('\t');
	Serial.print(state.wy * 180 / PI);
	Serial.print('\t');
	Serial.print(state.wz * 180 / PI);
	Serial.print('\t');
}
